...
export default function InsightsPage() {
  ...
  function showCard() {
    ...
    const token = localStorage.getItem("burntjacket.token");
    const acct = localStorage.getItem("burntjacket.account");
      ...
      <section className="card form-card">
        ...
        {cardUrl && (
          <div style={{ marginTop: 14 }}>
            ...
            <a className="btn light" href={cardUrl} download="burntjacket-collector-card.svg" style={{ marginTop: 10 }}>
              DOWNLOAD
            </a>
          </div>
        )}
