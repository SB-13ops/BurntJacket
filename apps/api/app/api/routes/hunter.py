...
from app.services.hunter_score import ScoreInput, calculate_burntjacket_score
    ...
    if discogs_account:
        ...
        for opp in opportunities:
            ...
            listing = MarketListing(
                ...
                release_id=opp.burntjacket_release_id,
            ...
            score_data = calculate_burntjacket_score(
                ScoreInput(
                    ...
                    pressing_match=100,  # exact Discogs release ID → Burnt Jacket release
            ...
            result = HuntResult(
                ...
                burntjacket_score=score_data["score"],
            ...
            created.append({
                ...
                "source": "discogs",
                "release_id": str(opp.burntjacket_release_id),
                "discogs_release_id": opp.discogs_release_id,
...
def hunt_results(hunt_id: UUID, ctx = Depends(require_account_read),
    ...
    rows = db.execute(
        ...
        .order_by(HuntResult.burntjacket_score.desc())
    ).all()
    ...
    for result, listing in rows:
        ...
        items.append({
            ...
            "score": result.burntjacket_score,
