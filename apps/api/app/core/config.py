...
class Settings(BaseSettings):
    ...
    app_name: str = "Burnt Jacket"
    database_url: str = "postgresql+psycopg://burntjacket:burntjacket@localhost:5432/burntjacket"
    ...
    discogs_user_agent: str = "Burnt Jacket/0.1"
    ...
    # --- Anthropic AI (Claude) ---
    # When set, Burnt Jacket uses Claude for natural-language hunt parsing, result
    ...
    # links (e.g. https://burntjacket-web.up.railway.app). Falls back to the first
    ...
    #   CORS_ALLOW_ORIGINS=https://burntjacket-web.up.railway.app
