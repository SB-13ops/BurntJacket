"""rename dead_wax_score to burntjacket_score

Revision ID: 0004_rename_score_column
Revises: 0003_user_auth_fields
Create Date: 2026-08-20

Product rename (Dead Wax -> Burnt Jacket). This renames the hunt_results score
...
def upgrade() -> None:
    op.alter_column("hunt_results", "dead_wax_score", new_column_name="burntjacket_score")


def downgrade() -> None:
    op.alter_column("hunt_results", "burntjacket_score", new_column_name="dead_wax_score")
