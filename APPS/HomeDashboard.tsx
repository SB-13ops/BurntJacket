...
const fallbackImg = "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(
  `<svg xmlns="http://www.w3.org/2000/svg" width="400" height="400">
   ...
   <text x="200" y="365" text-anchor="middle" fill="#eee0c2" font-size="30" font-family="Georgia">BURNT JACKET</text>
   </svg>`
);
...
export default function HomeDashboard() {
  ...
  useEffect(() => {
    apiGet<Feed>("/home/feed")
      ...
      .catch(() => setError("Burnt Jacket backend is not running yet."));
  }, []);
    ...
    return (
      <div>
        <div className="greeting">
          <h1>Good evening.</h1>
          <p>Burnt Jacket is ready — start the backend to load live data.</p>
        </div>
  ...
  if (!feed) {
    return <div className="status">Loading your Burnt Jacket feed...</div>;
  }

  const pick = feed.burntjacket_pick;
  ...
  return (
    <div className="right-grid">
      ...
      <div>
        <div className="greeting">
          <h1>Good evening.</h1>
          <p>Here's what Burnt Jacket found for you.</p>
        ...
        <div className="primary">
          <section className="card">
            <div className="panel-title"><span className="orange">🔥</span> BURNT JACKET PICK</div>
            {pick ? (
              <>
                <div className="pick">
                  <img className="pick-img" src={pick.image_url || fallbackImg} alt="" />
                  <div>
                    <div style={{fontSize:17}}>{pick.title.split("—")[0]?.trim() || "Burnt Jacket Pick"}</div>
                    ...
                    <div className="why">
                      <b>Why Burnt Jacket picked this</b><br />
